...
enum {
  ...
  sym_string_literal_single = 23,
  sym_string_literal_double = 24,
  sym_boolean_literal = 25,
  sym_numeric_literal = 26,
  aux_sym_config_file_repeat1 = 27,
  aux_sym_assignment_repeat1 = 28,
  aux_sym_scope_block_repeat1 = 29,
  aux_sym_string_literal_single_repeat1 = 30,
  aux_sym_string_literal_double_repeat1 = 31,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [21] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_config_file, 1),
  [23] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_config_file_repeat1, 2),
  [25] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_config_file_repeat1, 2), SHIFT_REPEAT(26),
  [28] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_config_file_repeat1, 2), SHIFT_REPEAT(11),
  [31] = {.entry = {.count = 1, .reusable = true}}, SHIFT(26),
  [33] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [35] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_scope_block_repeat1, 2), SHIFT_REPEAT(26),
  [38] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_scope_block_repeat1, 2),
  [40] = {.entry = {.count = 1, .reusable = true}}, SHIFT(15),
  [42] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [44] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [46] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_literal_single, 3),
  [48] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_literal_single, 3),
  [50] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scope_block, 3, .production_id = 1),
  [52] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_scope_block, 3, .production_id = 1),
  [54] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scope_block, 5, .production_id = 5),
  [56] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_scope_block, 5, .production_id = 5),
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scope_block, 4, .production_id = 5),
  [60] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_scope_block, 4, .production_id = 5),
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 4, .production_id = 4),
  [64] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_assignment, 4, .production_id = 4),
  [66] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_literal_single, 2),
  [68] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_literal_single, 2),
  [70] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scope_block, 4, .production_id = 1),
  [72] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_scope_block, 4, .production_id = 1),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_literal_double, 2),
  [76] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_literal_double, 2),
  [78] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_literal_double, 3),
  [80] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_literal_double, 3),
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_boolean_literal, 1),
  [84] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_boolean_literal, 1),
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_numeric_literal, 1),
  [88] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_numeric_literal, 1),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 3, .production_id = 3),
  [92] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_assignment, 3, .production_id = 3),
  [94] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_literal, 1),
  [96] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_literal, 1),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_literal, 1),
  [100] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_literal, 1),
  [102] = {.entry = {.count = 1, .reusable = true}}, SHIFT(39),
  [104] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [106] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_include, 2),
  [110] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_include, 2),
  ...
  [122] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_literal_single_repeat1, 2),
  [124] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_literal_single_repeat1, 2), SHIFT_REPEAT(30),
  [127] = {.entry = {.count = 1, .reusable = false}}, SHIFT(20),
  [129] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [131] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_literal_double_repeat1, 2),
  [133] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_literal_double_repeat1, 2), SHIFT_REPEAT(32),
  ...
  [146] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_assignment_repeat1, 2, .production_id = 2), SHIFT_REPEAT(37),
  [149] = {.entry = {.count = 1, .reusable = true}},  ACCEPT_INPUT(),
  [151] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_assignment_repeat1, 2, .production_id = 1),
};
